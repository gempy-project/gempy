import gempy as gp
from examples.examples.geometries.a01_horizontal_stratigraphic import generate_horizontal_stratigraphic_model
...
def test_generate_horizontal_stratigraphic_model():
    model = generate_horizontal_stratigraphic_model()
    assert isinstance(model, gp.GeoModel)
