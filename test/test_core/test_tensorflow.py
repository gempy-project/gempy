...
def test_basic_tf():
    dips_position = tf.constant([[1,0],[1,1]],dtype = tf.float32)
    surface_position = tf.constant([[[0,0],[2,0]],[[0,2],[2,2]]],dtype = tf.float32)
    dips = tf.constant([[1,1],[1,1]],dtype= tf.float32)
